          ...
          <div className="relative">
            ...
            {portfolioData.experience.map((exp) => (
              <div key={exp.id} className="mb-12 relative">
                <div className="absolute left-6 top-8 w-5 h-5 rounded-full bg-blue-600 border-4 border-white shadow-lg"></div>
                
                <Card className="ml-20 p-8 hover:shadow-2xl transition-all duration-300 bg-white">
                  ...
                  <div>
                    ...
                    <div className="grid gap-4">
                      {exp.projects.map((project, index) => (
                        <Card key={index} className="p-4 bg-slate-50 border-l-4 border-cyan-600">
